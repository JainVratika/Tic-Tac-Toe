...
function test_btn(x){
    ...
    function check_result()
    {
        ...
        if (arr1[1]===arr2[1] && arr2[1]===arr3[1] && arr2[1]!=0)
            {
            result=true
            announce_result(arr1[1])
            }// cond 6 col 3
        if (arr1[2]===arr2[2] && arr2[2]===arr3[2] && arr2[2]!=0)
            {
            result=true
            announce_result(arr2[2])
            }// cond 7 diag 1
        ...
        if (arr3[0]===arr2[1] && arr2[1]=== arr1[2] && arr1[2]!=0)
            {
            result=true
            announce_result(arr1[3])
            }
